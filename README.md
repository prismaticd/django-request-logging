...
See `REQUEST_LOGGING_HTTP_4XX_NOT_ERROR` setting to override this. 
...
### REQUEST_LOGGING_HTTP_4XX_AS_ERROR
By default, HTTP status codes between 400 - 499 are logged at ERROR level.  You can set `REQUEST_LOGGING_HTTP_4XX_AS_ERROR=False` to disable this,
so they are logged as per non-error requests.
